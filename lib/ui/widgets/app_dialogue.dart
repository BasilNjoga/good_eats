...
class AppDialog {
  static String _addOnClick({required TextEditingController textEditingController}) {
  ...
  static String _subtrackOnClick({required TextEditingController textEditingController}) {
  ...
  static String _onTextFieldChange({required String quantity}) {
    print('On change text field here!');
    return quantity;
  }

  static void _cancelOnClick({required BuildContext context, required int quantity}) {
    print('Cancel change here!');
    Navigator.of(context).pop(quantity);
  }

  static void _confirmOnClick({required BuildContext context, required int newQuantity}) {
