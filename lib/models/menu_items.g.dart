...
extension MenuQueryFilter on QueryBuilder<Menu, Menu, QFilterCondition> {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleEqualTo(
    String value, {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'title',
        value: '',
  ...
  QueryBuilder<Menu, Menu, QAfterFilterCondition> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'title',
        value: '',
...
extension MenuQuerySortBy on QueryBuilder<Menu, Menu, QSortBy> {
  QueryBuilder<Menu, Menu, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Menu, Menu, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MenuQuerySortThenBy on QueryBuilder<Menu, Menu, QSortThenBy> {
  ...
  QueryBuilder<Menu, Menu, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Menu, Menu, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension MenuQueryWhereDistinct on QueryBuilder<Menu, Menu, QDistinct> {
  QueryBuilder<Menu, Menu, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MenuQueryProperty on QueryBuilder<Menu, Menu, QQueryProperty> {
  ...
  QueryBuilder<Menu, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
